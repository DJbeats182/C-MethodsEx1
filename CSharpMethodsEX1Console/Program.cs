    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Okay {userName}, here is a story that I made up using your responses:\n" +
                              $"One summer evening there was a {favoriteAnimal} named {userName}.\n" +
                              $"{userName} was a curious little guy and wanted to know how high he could fly\n" +
                              $"So he turned on some '{favoriteBand}', hopped in a {favoriteColor} rocket, and he took to the sky");
